...
class VisualiseWorkScheduleDateRange(bpy.types.Operator):
    ...
    def execute(self, context):
        print(f"🚀 DEBUG: VisualiseWorkScheduleDateRange.execute() called")
        print(f"🚀 DEBUG: camera_action = {self.camera_action}")
        ...
        try:
            ...
            for product_id, frame_data_list in product_frames.items():
                ...
                for frame_data in frame_data_list:
                    ...
                    if states:
                        ...
                        print(f"🔍 DEBUG_WORK_SCHEDULE: Processing {obj.name}")
            ...
            print(f"🎥 DEBUG: About to check camera_action: {self.camera_action}")
            if self.camera_action != 'NONE':
                print(f"🎥 DEBUG: Camera action is not NONE, proceeding with camera logic")
                ...
                try:
                    ...
                    print(f"🔍 DEBUG SELECTOR: active_animation_camera = '{active_camera_name}'")
                    print(f"🔍 DEBUG SELECTOR: Type = {type(active_camera_name)}")
                    ...
                    if hasattr(active_camera_name, 'name'):
                        ...
                        print(f"🔍 DEBUG: active_animation_camera is object, name = '{camera_name_str}'")
                    elif isinstance(active_camera_name, str):
                        # It's already a string
                        camera_name_str = active_camera_name
                        print(f"🔍 DEBUG: active_animation_camera is string = '{camera_name_str}'")
                    else:
                        # Unknown type or None
                        camera_name_str = None
                        print(f"🔍 DEBUG: active_animation_camera is unknown type or None")
                ...
                if self.camera_action == 'UPDATE':
                    ...
                    if existing_cam:
                        ...
                        try:
                            ...
                            # Guardar todos los valores del panel en la cámara
