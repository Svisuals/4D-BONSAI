...
def register():
    ...
    # ---register camera orbit property group and test operators ---
    try:
    ...
    # ---  dynamically attach camera_orbit pointer after classes are registered ---
    try:
...
def unregister():
    # === REMOVE CACHE INVALIDATION HANDLER ===
    try:
