...
class BIM_PT_animation_tools(Panel):
    ...
    def draw_visualisation_ui(self):
        ...
        # Deshabilitar si CUALQUIER estado está activo (animación o snapshot) OR tasks are not opened
        ...
        # Reset Button - solo habilitado si hay animación activa
    ...
    def draw_snapshot_ui(self):
        ...
        # Reset Button - solo habilitado si hay snapshot activo
        ...
        try:
            ...
            # PERMITIR cambio de cámara durante snapshots
    ...
    def draw_camera_orbit_ui(self):
        ...
        # PERMITIR selector durante animación para cambiar entre cámaras static
        # (El filtro ya se encarga de mostrar solo cámaras apropiadas)
        row.enabled = True
