...
class GanttSequence:
    """Genera los datos para el gráfico de Gantt basado en web."""
    ...
    def generate_gantt_browser_chart(
        ...
        try:
            web_props = tool.Web.get_web_props()
            if not web_props.is_connected:
                bpy.ops.bim.connect_websocket_server(page="sequencing")
        except AttributeError:
            # WebProperties not available, try to connect anyway
            bpy.ops.bim.connect_websocket_server(page="sequencing")
