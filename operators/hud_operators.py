...
classes = [
    ArrangeScheduleTexts,
    Fix3DTextAlignment,
    SetupTextHUD,
    ClearTextHUD,
    UpdateTextHUDPositions,
    UpdateTextHUDScale,
    ToggleTextHUD,
    Setup3DLegendHUD,
    Clear3DLegendHUD,
    ...
    ToggleScheduleHUD,
    RefreshScheduleHUD,
    LegendHudcolortypeScrollUp,
    LegendHudcolortypeScrollDown,
    LegendHudTogglecolortypeVisibility,
]

def register():
    # Helper methods are bound to the class definition itself
    SetupTextHUD._setup_text_as_hud = SetupTextHUD._setup_text_as_hud
    SetupTextHUD._get_aspect_ratio = SetupTextHUD._get_aspect_ratio
    SetupTextHUD._calculate_hud_position = SetupTextHUD._calculate_hud_position
    SetupTextHUD._update_text_scale = SetupTextHUD._update_text_scale
    UpdateTextHUDPositions._calculate_hud_position = SetupTextHUD._calculate_hud_position
    UpdateTextHUDScale._update_text_scale = SetupTextHUD._update_text_scale
    Setup3DLegendHUD._get_active_colortype_data = Setup3DLegendHUD._get_active_colortype_data
    Setup3DLegendHUD._get_synchronized_settings = Setup3DLegendHUD._get_synchronized_settings
    Setup3DLegendHUD._create_3d_legend_hud = Setup3DLegendHUD._create_3d_legend_hud
    Setup3DLegendHUD._create_rounded_panel = Setup3DLegendHUD._create_rounded_panel
    Setup3DLegendHUD._create_color_dot = Setup3DLegendHUD._create_color_dot
    Setup3DLegendHUD._create_text_object = Setup3DLegendHUD._create_text_object
    Setup3DLegendHUD._create_emission_material = Setup3DLegendHUD._create_emission_material
