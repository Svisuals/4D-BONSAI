...
classes = (
    ...
    operator.DebugTimelineHUD,
    operator.LoadAndActivatecolortypeGroup,
    operator.NavigateColumnsEnd,
    operator.NavigateColumnsHome,
    ...
    operator.TestScheduleHUD,
    operator.TestSynchroTimelineHUD,
    operator.TestTimelineHUDControls,
    operator.UpdateDefaultcolortypeColors,
